...
class UserRepository(Protocol):
    ...
    ) -> AppResult[dto.user.UserPrivate]: ...
    ...
    ) -> AppResult[OffsetPaginationResult[dto.user.UserPrivate]]: ...
    async def create(self, data: user.CreateUserData) -> AppResult[dto.user.UserPrivate]: ...
    async def update(
        self,
...
class RbacRepository(Protocol):
    ...
    async def get_role_users(
        self,
        role_id: uuid.UUID,
    ) -> AppResult[Sequence[dto.user.UserPrivate]]: ...
